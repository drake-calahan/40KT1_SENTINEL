...
| [Relevés](releves/) | PO, agents | Faits mesurés qui conditionnent un arbitrage — `P01.10` |
...
ont été tranchées par le PO, les trois ADR sont *Acceptées*
(`ADR-001` l'est depuis `P00.2`, le 2026-09-07). Le contrat de frontière n'engage encore que
